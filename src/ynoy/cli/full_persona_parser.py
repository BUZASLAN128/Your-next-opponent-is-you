...
def add_full_persona_parsers(
    ...
    package = commands.add_parser("build-full-persona-package")
    package.add_argument("run_id")
    package.add_argument("--synthetic", action="store_true")
    life = commands.add_parser("build-full-persona-life-profile")
    life.add_argument("run_id")
    life.add_argument("--synthetic", action="store_true")
